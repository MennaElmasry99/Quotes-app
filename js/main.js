var quouteList=[
   ...
   "Martin Luther King Jr.“Darkness cannot drive out darkness: only light can do that. Hate cannot drive out hate: only love can do that.”― Martin Luther King Jr.",
...
//random index && display the quotes
function display(){
    var randomIndex = Math.floor(Math.random() * quouteList.length);
   var quote = quouteList[randomIndex];
